...
void controller_oneStep(void)
{
  ...
  // Re-enable timer or interrupt here
  // Set model inputs here
  controllerObj.rtU.X_b[0] = cart_position;
  controllerObj.rtU.X_b[1] = cart_pos_vel;
  controllerObj.rtU.X_b[2] = pend_angle_wrapped;
  controllerObj.rtU.X_b[3] = pend_ang_vel;

  controllerObj.rtU.error[0] = ref_signal[0] - cart_position;
  controllerObj.rtU.error[1] = ref_signal[1] - cart_pos_vel;
  controllerObj.rtU.error[2] = ref_signal[2] - pend_angle_wrapped;
  controllerObj.rtU.error[3] = ref_signal[3] - pend_ang_vel;
